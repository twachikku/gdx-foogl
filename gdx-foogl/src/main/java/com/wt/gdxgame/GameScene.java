...
public abstract class GameScene extends Stage implements Screen {
	...
	final public ActorBuilder add   = new ActorBuilder(this);
	final public AssetLoader  load  = new AssetLoader(this);
	...
	public GameScene (GameApp app, GameScene previousScene) {
