...
public class GdxSetupUI extends JFrame {
	...
	public GdxSetupUI () {
		setTitle("GDX-FooGL Project Generator");
		...
		dependencies.add(builder.bank.getDependency(ProjectDependency.BOX2DLIGHTS));
	}
	...
	class Form extends JPanel {
		...
		JTextField nameText = new JTextField("my-foogl-game");
		JLabel packageLabel = new JLabel("Package:");
		JTextField packageText = new JTextField("com.foogl.game");
		JLabel gameClassLabel = new JLabel("Game class:");
		JTextField gameClassText = new JTextField("MyGame");
			...
			for (int row = 0; row <= (ProjectDependency.values().length / 5); row++) {
				...
				while (depCounter < ProjectDependency.values().length) {
					if (ProjectDependency.values()[depCounter] != null) {
						...
						if (projDep.equals(ProjectDependency.BOX2D)||projDep.equals(ProjectDependency.BOX2DLIGHTS)) {
