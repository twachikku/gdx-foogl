...
public class GdxSetup {
	...
	public void build (ProjectBuilder builder, String outputDir, String appName, String packageName, String mainClass,
		...
		// core project
		project.files.add(new ProjectFile("game/build.gradle"));
		project.files.add(new ProjectFile("game/src/MainClass", "game/src/" + packageDir + "/" + mainClass + ".java", true));
		project.files.add(new ProjectFile("game/src/DemoScene", "game/src/" + packageDir + "/DemoScene.java", true));
		if (builder.modules.contains(ProjectType.HTML)) {
			project.files.add(new ProjectFile("game/CoreGdxDefinition", "game/src/" + mainClass + ".gwt.xml", true));
		}
		...
		// Assets
		String assetPath = "game/assets"; //builder.modules.contains(ProjectType.ANDROID) ? "android/assets" : "core/assets";
		project.files.add(new ProjectFile("game/assets/gfx/foogl.png", assetPath + "/gfx/foogl.png", false));
		project.files.add(new ProjectFile("game/assets/gfx/loading.png", assetPath + "/gfx/loading.png", false));
		project.files.add(new ProjectFile("game/gdxfoogl.jar", "game/libs/gdxfoogl.jar", false));
